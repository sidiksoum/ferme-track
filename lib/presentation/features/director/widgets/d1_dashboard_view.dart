...
class D1DashboardView extends StatefulWidget {
  final VoidCallback onViewNotifications;

  const D1DashboardView({super.key, required this.onViewNotifications});

  @override
  State<D1DashboardView> createState() => _D1DashboardViewState();
}

class _D1DashboardViewState extends State<D1DashboardView> {
