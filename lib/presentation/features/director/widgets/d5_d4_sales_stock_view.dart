                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton<String>(
                    ...
                    items: const [
                      ...
                      DropdownMenuItem(value: '30j', child: Text('Mois en cours')),
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                _salesPeriodFilter == 'today'
                    ? '45 000 FCFA'
                    : (_salesPeriodFilter == '30j' ? '820 000 FCFA' : '245 000 FCFA'),
    ...
    return Column(
      ...
      children: [
        ...
        if (_stockSubTab == 'magasin') ...[
          ...
          _buildStockItem('Aliment ponte (Mangeoire)', 4, 'sacs', 'OK', 0.80, AppColors.primary),
          _buildStockItem('Aliment croissance (Mangeoire)', 2, 'sacs', 'Bas', 0.40, AppColors.accent),
          _buildStockItem('Désinfectant', 15, 'litres', 'OK', 0.75, AppColors.primary),
          _buildStockItem('Eau de boisson', 500, 'litres', 'OK', 0.90, AppColors.primary),
        ],
      ],
    );
  }
